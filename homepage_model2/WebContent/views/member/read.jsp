...
<div id="w">
	...
	<table>
		<tr>
			<td colspan="2" class="text-align-c table-bordered td">
				<img src="${pageContext.request.contextPath }/views/member/storage/${dto.fname}" class="text-align-c" style="width:250px">
			</td>
		</tr>
		<tr>
	...
	<c:choose>
		...
		<input type='button' value='다운로드' class="button" onclick="location.href='${pageContext.request.contextPath }/download?dir=/views/member/storage&filename=${dto.fname }'">
		</c:when>
		<c:otherwise>
		<input type='button' value='정보수정' class="button" onclick="update()">
