...
<div id="w">
	...
	<form name='frm' method='POST' action='./updateProc.do' onsubmit="return inputCheck(this)">
		...
		<table>
			<tr>
				<td colspan="3" class="text-align-c table-bordered td">
					<img src="${pageContext.request.contextPath }/views/member/storage/${dto.fname}" style="width:300px">
				</td>
			</tr>
			<tr>
