...
<body>
	<div id="w">
		...
		<form name="frm" action="./updateProc.do" method="POST"
			...
			<table>
				<tr>
					<th colspan="2" class="table-bordered th text-align-c">
						<div>
							<img src="${pageContext.request.contextPath }/views/team/storage/${dto.filename}" style="width:250px">
						</div>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="table-bordered td"><input type="text" name="phone"
						value="${dto.phone }"></td>
				</tr>
				<tr>
			...
			<div class="bottom">
				<input type="submit" class="button" value="수정"> <input
					type="reset" class="button" value="다시입력"> <input
					type="button" class="button" value="목록" onclick="tlist()">
			</div>
		</form>
	</div>
</body>
