...
<body>
	<div id="w">
		...
		<FORM name='frm' method='POST' action='./updateProc.do'
			...
			<input name="no" value="${no }" type="hidden"> <input
				name="col" value="${param.col }" type="hidden">
			<input name="word" value="${param.word }"
				type="hidden"> <input name="nowPage"
				value="${param.nowPage }" type="hidden">
			<input name="oldfile" value="${oldfile }" type="hidden">
			<TABLE style="width: 45%;">
				...
				<TR>
					...
					<TD class="table-bordered td"><input type="file"
						name="filename" size="40">${dto.filename }</TD>
				</TR>
				<TR>
