...
<FORM name='frm' 
  ...
  <TABLE>
    ...
    <TR>
      ...
      <TD class="table-bordered td"><input type="text" name="title" value="${dto.title }"></TD>
    </TR>
    <TR>
      <TH class="table-bordered th">파일</TH>
      <TD class="table-bordered td"><input type="file" name="filename"></TD>
    </TR>
    <TR>
      <TH class="table-bordered th">내용</TH>
      <TD class="table-bordered td"><textarea rows="10" cols="45" name="content"></textarea></TD>
    </TR>
    <TR>
    ...
    <input type='button' value='취소' class="button" onclick="location.href='./lsit.do'">
  </DIV>
</FORM>
</div>
